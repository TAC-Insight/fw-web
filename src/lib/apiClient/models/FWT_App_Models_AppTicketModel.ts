...
import type { FWT_App_Models_CashSaleModel } from './FWT_App_Models_CashSaleModel';

export type FWT_App_Models_AppTicketModel = {
    ticketNumber?: number;
    orderKey?: number;
    ...
    cashSale?: FWT_App_Models_CashSaleModel;
};
