...
import type { FWT_Customers_Models_CustomerRegionModel } from './FWT_Customers_Models_CustomerRegionModel';

export type FWT_Customers_Models_CustomerModel = {
    customerKey?: number;
    customerID: string;
    customerName: string;
    ...
    regions?: Array<FWT_Customers_Models_CustomerRegionModel> | null;
